...
dem<-rast("data/srtm_germany_dsm.tif")  #Source: https://www.opendem.info/download_srtm.html
...
for (i in map_files){
  ...
  for (j in c(2050,2085)){
    ...
    for (k in c("quantile10", "median", "quantile90")){
      ...
      model_interpolation <- 
        tryCatch({
          withTimeout({ model_interpolation <- scam(n_years_damage_10~s(dem, k=4, bs = "mpi"), data=gdf)}, timeout=30 , cpu = Inf)
        }, error = function(e){
          if(grepl("reached elapsed time limit",e$message))
            model <- lm(n_years_damage_10~dem, data = gdf) else
      ...
      # calculate residuals
      gdf$residuals <- gdf$n_years_damage_10 - gdf$damage_trend
      ...
      filename_save<-paste0("data/map_preparation/",i,"_",j,"_",k,".rds")
...
#ssp 585 early####
raster_early_ssp585_2050_median<-readRDS("data/map_preparation/map_data_early_ssp585.csv_2050_median.rds")
raster_early_ssp585_2050_quantile10<-readRDS("data/map_preparation/map_data_early_ssp585.csv_2050_quantile10.rds")
raster_early_ssp585_2050_quantile90<-readRDS("data/map_preparation/map_data_early_ssp585.csv_2050_quantile90.rds")
raster_early_ssp585_2085_median<-readRDS("data/map_preparation/map_data_early_ssp585.csv_2085_median.rds")
raster_early_ssp585_2085_quantile10<-readRDS("data/map_preparation/map_data_early_ssp585.csv_2085_quantile10.rds")
raster_early_ssp585_2085_quantile90<-readRDS("data/map_preparation/map_data_early_ssp585.csv_2085_quantile90.rds")
...
png("new_names_ssp585_early.png", pointsize=8, width=5700, height=4600, res=600)
ssp585_early_all <- c(A4,B4,C4,D4,E4,F4, layout = c(3,2), merge.legends = T)
print(ssp585_early_all)
update(ssp585_early_all, scales = list(alternating = 1))
dev.off()
...
#ssp 126 early####
raster_early_ssp126_2050_median<-readRDS("data/map_preparation/map_data_early_ssp126.csv_2050_median.rds")
raster_early_ssp126_2050_quantile10<-readRDS("data/map_preparation/map_data_early_ssp126.csv_2050_quantile10.rds")
raster_early_ssp126_2050_quantile90<-readRDS("data/map_preparation/map_data_early_ssp126.csv_2050_quantile90.rds")
raster_early_ssp126_2085_median<-readRDS("data/map_preparation/map_data_early_ssp126.csv_2085_median.rds")
raster_early_ssp126_2085_quantile10<-readRDS("data/map_preparation/map_data_early_ssp126.csv_2085_quantile10.rds")
raster_early_ssp126_2085_quantile90<-readRDS("data/map_preparation/map_data_early_ssp126.csv_2085_quantile90.rds")
...
png("new_names_ssp126_early.png", pointsize=8, width=5700, height=4600, res=600)
ssp126_early_all <- c(A1,B1,C1,D1,E1,F1, layout = c(3,2), merge.legends = T)
print(ssp126_early_all)
update(ssp126_early_all, scales = list(alternating = 1))
dev.off()
...
#ssp 245 early####
raster_early_ssp245_2050_median<-readRDS("data/map_preparation/map_data_early_ssp245.csv_2050_median.rds")
raster_early_ssp245_2050_quantile10<-readRDS("data/map_preparation/map_data_early_ssp245.csv_2050_quantile10.rds")
raster_early_ssp245_2050_quantile90<-readRDS("data/map_preparation/map_data_early_ssp245.csv_2050_quantile90.rds")
raster_early_ssp245_2085_median<-readRDS("data/map_preparation/map_data_early_ssp245.csv_2085_median.rds")
raster_early_ssp245_2085_quantile10<-readRDS("data/map_preparation/map_data_early_ssp245.csv_2085_quantile10.rds")
raster_early_ssp245_2085_quantile90<-readRDS("data/map_preparation/map_data_early_ssp245.csv_2085_quantile90.rds")
...
png("new_names_ssp245_early.png", pointsize=8, width=5700, height=4600, res=600)
ssp245_early_all <- c(A2,B2,C2,D2,E2,F2, layout = c(3,2), merge.legends = T)
print(ssp245_early_all)
update(ssp245_early_all, scales = list(alternating = 1))
dev.off()
...
#ssp 370 early####
raster_early_ssp370_2050_median<-readRDS("data/map_preparation/map_data_early_ssp370.csv_2050_median.rds")
raster_early_ssp370_2050_quantile10<-readRDS("data/map_preparation/map_data_early_ssp370.csv_2050_quantile10.rds")
raster_early_ssp370_2050_quantile90<-readRDS("data/map_preparation/map_data_early_ssp370.csv_2050_quantile90.rds")
raster_early_ssp370_2085_median<-readRDS("data/map_preparation/map_data_early_ssp370.csv_2085_median.rds")
raster_early_ssp370_2085_quantile10<-readRDS("data/map_preparation/map_data_early_ssp370.csv_2085_quantile10.rds")
raster_early_ssp370_2085_quantile90<-readRDS("data/map_preparation/map_data_early_ssp370.csv_2085_quantile90.rds")
...
png("new_names_ssp370_early.png", pointsize=8, width=5700, height=4600, res=600)
ssp370_early_all <- c(A3,B3,C3,D3,E3,F3, layout = c(3,2), merge.legends = T)
print(ssp370_early_all)
update(ssp370_early_all, scales = list(alternating = 1))
dev.off()
...
png("new_names_median_all_ssp_early_damage10.png", pointsize=8, width=3600, height=8000, res=600)
median_all_ssp<-c(B1m,E1m,B2m,E2m,B3m,E3m,B4m,E4l, layout=c(2,4), merge.legends=T)
print(median_all_ssp)
...
#Extra Plot Manuscript
png("figures/new_names_ssp370_early_nur_2085.png", pointsize=8, width=5000, height=2300, res=600)
ssp370_early_2085 <- c(D3,E3,F3, layout = c(3,1), merge.legends = T)
print(ssp370_early_2085)
update(ssp370_early_2085, scales = list(alternating = 1))
dev.off()


#ssp 585 late####
raster_late_ssp585_2050_median<-readRDS("data/map_preparation/map_data_late_ssp585.csv_2050_median.rds")
raster_late_ssp585_2050_quantile10<-readRDS("data/map_preparation/map_data_late_ssp585.csv_2050_quantile10.rds")
raster_late_ssp585_2050_quantile90<-readRDS("data/map_preparation/map_data_late_ssp585.csv_2050_quantile90.rds")
raster_late_ssp585_2085_median<-readRDS("data/map_preparation/map_data_late_ssp585.csv_2085_median.rds")
raster_late_ssp585_2085_quantile10<-readRDS("data/map_preparation/map_data_late_ssp585.csv_2085_quantile10.rds")
raster_late_ssp585_2085_quantile90<-readRDS("data/map_preparation/map_data_late_ssp585.csv_2085_quantile90.rds")
...
A4<-rasterVis::levelplot(raster_late_ssp585_2050_quantile10$var1.pred_total,
                         margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
...
B4<-rasterVis::levelplot(raster_late_ssp585_2050_median$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
C4<-rasterVis::levelplot(raster_late_ssp585_2050_quantile90$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
D4<-rasterVis::levelplot(raster_late_ssp585_2085_quantile10$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
E4<-rasterVis::levelplot(raster_late_ssp585_2085_median$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
F4<-rasterVis::levelplot(raster_late_ssp585_2085_quantile90$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
# Combination via `c.trellis`
ssp585_late_all <- c(A4,B4,C4,D4,E4,F4, layout = c(3,2), merge.legends = T)
print(ssp585_late_all)
update(ssp585_late_all, scales = list(alternating = 1))

png("new_names_ssp585_late.png", pointsize=8, width=5700, height=4600, res=600)
ssp585_late_all <- c(A4,B4,C4,D4,E4,F4, layout = c(3,2), merge.legends = T)
print(ssp585_late_all)
update(ssp585_late_all, scales = list(alternating = 1))
dev.off()
...
#ssp 126 late####
raster_late_ssp126_2050_median<-readRDS("data/map_preparation/map_data_late_ssp126.csv_2050_median.rds")
raster_late_ssp126_2050_quantile10<-readRDS("data/map_preparation/map_data_late_ssp126.csv_2050_quantile10.rds")
raster_late_ssp126_2050_quantile90<-readRDS("data/map_preparation/map_data_late_ssp126.csv_2050_quantile90.rds")
raster_late_ssp126_2085_median<-readRDS("data/map_preparation/map_data_late_ssp126.csv_2085_median.rds")
raster_late_ssp126_2085_quantile10<-readRDS("data/map_preparation/map_data_late_ssp126.csv_2085_quantile10.rds")
raster_late_ssp126_2085_quantile90<-readRDS("data/map_preparation/map_data_late_ssp126.csv_2085_quantile90.rds")
...
png("new_names_ssp126_late.png", pointsize=8, width=5700, height=4600, res=600)
ssp126_late_all <- c(A1,B1,C1,D1,E1,F1, layout = c(3,2), merge.legends = T)
print(ssp126_late_all)
update(ssp126_late_all, scales = list(alternating = 1))
dev.off()
...
#ssp 245 late####
raster_late_ssp245_2050_median<-readRDS("data/map_preparation/map_data_late_ssp245.csv_2050_median.rds")
raster_late_ssp245_2050_quantile10<-readRDS("data/map_preparation/map_data_late_ssp245.csv_2050_quantile10.rds")
raster_late_ssp245_2050_quantile90<-readRDS("data/map_preparation/map_data_late_ssp245.csv_2050_quantile90.rds")
raster_late_ssp245_2085_median<-readRDS("data/map_preparation/map_data_late_ssp245.csv_2085_median.rds")
raster_late_ssp245_2085_quantile10<-readRDS("data/map_preparation/map_data_late_ssp245.csv_2085_quantile10.rds")
raster_late_ssp245_2085_quantile90<-readRDS("data/map_preparation/map_data_late_ssp245.csv_2085_quantile90.rds")
...
A2<-rasterVis::levelplot(raster_late_ssp245_2050_quantile10$var1.pred_total,
                         margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
...
B2<-rasterVis::levelplot(raster_late_ssp245_2050_median$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
C2<-rasterVis::levelplot(raster_late_ssp245_2050_quantile90$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
D2<-rasterVis::levelplot(raster_late_ssp245_2085_quantile10$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
E2<-rasterVis::levelplot(raster_late_ssp245_2085_median$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
F2<-rasterVis::levelplot(raster_late_ssp245_2085_quantile90$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
# Combination via `c.trellis`
ssp245_late_all <- c(A2,B2,C2,D2,E2,F2, layout = c(3,2), merge.legends = T)
print(ssp245_late_all)
update(ssp245_late_all, scales = list(alternating = 1))

png("new_names_ssp245_late.png", pointsize=8, width=5700, height=4600, res=600)
ssp245_late_all <- c(A2,B2,C2,D2,E2,F2, layout = c(3,2), merge.legends = T)
print(ssp245_late_all)
update(ssp245_late_all, scales = list(alternating = 1))
dev.off()
...
#ssp 370 late####
raster_late_ssp370_2050_median<-readRDS("data/map_preparation/map_data_late_ssp370.csv_2050_median.rds")
raster_late_ssp370_2050_quantile10<-readRDS("data/map_preparation/map_data_late_ssp370.csv_2050_quantile10.rds")
raster_late_ssp370_2050_quantile90<-readRDS("data/map_preparation/map_data_late_ssp370.csv_2050_quantile90.rds")
raster_late_ssp370_2085_median<-readRDS("data/map_preparation/map_data_late_ssp370.csv_2085_median.rds")
raster_late_ssp370_2085_quantile10<-readRDS("data/map_preparation/map_data_late_ssp370.csv_2085_quantile10.rds")
raster_late_ssp370_2085_quantile90<-readRDS("data/map_preparation/map_data_late_ssp370.csv_2085_quantile90.rds")
...
A3<-rasterVis::levelplot(raster_late_ssp370_2050_quantile10$var1.pred_total,
                         margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
...
B3<-rasterVis::levelplot(raster_late_ssp370_2050_median$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
C3<-rasterVis::levelplot(raster_late_ssp370_2050_quantile90$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
D3<-rasterVis::levelplot(raster_late_ssp370_2085_quantile10$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
E3<-rasterVis::levelplot(raster_late_ssp370_2085_median$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
F3<-rasterVis::levelplot(raster_late_ssp370_2085_quantile90$var1.pred_total,margin=F,
                         #col.regions=turbo(100),
                         col.regions=viridis(100, direction = -1),
                         at=seq(0, 100, length.out=100),
                         #main="2008 to 2022",
...
# Combination via `c.trellis`
ssp370_late_all <- c(A3,B3,C3,D3,E3,F3, layout = c(3,2), merge.legends = T)
print(ssp370_late_all)
update(ssp370_late_all, scales = list(alternating = 1))

png("new_names_ssp370_late.png", pointsize=8, width=5700, height=4600, res=600)
ssp370_late_all <- c(A3,B3,C3,D3,E3,F3, layout = c(3,2), merge.legends = T)
print(ssp370_late_all)
update(ssp370_late_all, scales = list(alternating = 1))
dev.off()
